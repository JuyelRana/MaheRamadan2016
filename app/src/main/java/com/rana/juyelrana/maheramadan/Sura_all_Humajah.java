...
public class Sura_all_Humajah extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sura_all__humajah);
        tv = (TextView)findViewById(R.id.txt_sura_al_humaja);
