...
public class Sura_Al_Quraiys extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sura__al__quraiys);

        tv = (TextView)findViewById(R.id.txt_sura_al_quriys);
        tv.setMovementMethod(new ScrollingMovementMethod());

        player = MediaPlayer.create(this, R.raw.qurayus);
