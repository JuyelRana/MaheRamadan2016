...
public class Sura_ZilZal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sura__zil_zal);

        tv = (TextView)findViewById(R.id.txt_sura_al_zilzal);
        tv.setMovementMethod(new ScrollingMovementMethod());

        player = MediaPlayer.create(this, R.raw.zilzal);
        ...
        getSupportActionBar().setTitle("সুরা : আল-জিলজাল");
    }
