...
public class Sura_al_Kariah extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sura_al__kariah);

        tv = (TextView)findViewById(R.id.txt_sura_al_alkariah);
        tv.setMovementMethod(new ScrollingMovementMethod());

        player = MediaPlayer.create(this, R.raw.qaria);
