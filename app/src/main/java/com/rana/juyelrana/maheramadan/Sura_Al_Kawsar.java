...
public class Sura_Al_Kawsar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sura__al__kawsar);

        tv = (TextView)findViewById(R.id.txt_sura_al_kawsar);
        tv.setMovementMethod(new ScrollingMovementMethod());

        player = MediaPlayer.create(this, R.raw.kawsar);
